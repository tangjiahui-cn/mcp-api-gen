...
<img src="https://cdn.jsdelivr.net/gh/tangjiahui-cn/assets@master/mcp-api-gen/one-sentence-generation-v2.gif" height="550" alt="默认模板生成 API"/>

用户提供 API 示例生成：

<img src="https://cdn.jsdelivr.net/gh/tangjiahui-cn/assets@master/mcp-api-gen/user-example-generation-v2.gif" height="550" alt="用户提供 API 示例生成"/>
